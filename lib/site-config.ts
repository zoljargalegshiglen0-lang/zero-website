...
export const defaultSiteConfig: SiteConfig = {
  ...
  announcement: {
    ...
    buttonText: "OPEN SERVERS",
    buttonHref: "/servers",
  },
  cards: [
    { title: "Skinchanger", text: "Skins, stickers, charms and complete loadouts.", href: "/skinchanger", icon: "skin" },
    { title: "Leaderboard", text: "Competitive ranking and player stats.", href: "/leaderboard", icon: "trophy" },
    { title: "Staff Team", text: "Community staff directory.", href: "/staff", icon: "staff" },
    { title: "Store", text: "Membership and community items.", href: "/collection", icon: "crown" },
  ],
  servers: [
